  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear">
      ...
      <div id="logo" class="fl_left">
        <h1><a href="index.html">ICOTEL</a></h1>
      </div>
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li><a class="drop" href="#">About Us</a>
            <ul>
              <li><a href="pages/gallery.html">Our Images</a></li>
              <li><a href="pages/full-width.html">Our Members</a></li>
              <li><a href="pages/sidebar-left.html">Our Executive Bureau</a></li>
              <li><a href="pages/collaborations.html">Our Collaborations</a></li>
            </ul>
          </li>
          <li><a class="drop" href="#">Our Events/Co-Events</a>
            <ul>
              <li><a href="#"></a></li>
              <li><a class="drop" href="#">General Assembly 2018</a>
                <ul>
                  <li><a href="#">COT Premuim Awards 2018</a></li>
                </ul>
              </li>
  ...
  <div id="pageintro" class="hoc clear">
    <div class="flexslider basicslider">
      ...
      <ul class="slides">
        <li>
          <article>
            <p class="heading">ICOTEL</p>
            <h2 class="heading">Innovative College of Technology Ladies</h2>
            <p>is an association of young female students
             of the College of Technology, University of Buea</p>
            <footer><a class="btn" href="http://www.cot-ub.org/">COT Website</a></footer>
          </article>
        </li>
        <li>
          <article>
            <p class="heading">The idea was born in the 2014/2015,academic year</p>
            <h2 class="heading">with the aim Of</h2>
            <p>Solving the challenges faced by the girls in the
            College of Technology and the girls in general due to their minority</p>
            <footer><a class="btn" href="#">Our Publications</a></footer>
          </article>
        </li>
        <li>
          <article>
...
<div class="wrapper coloured">
  <article class="hoc cta clear">
    <!-- ################################################################################################ -->
    <h6 class="three_quarter first">Take a Look at our Calendar of Activities for the 2018/2019 academic year</h6>
    <footer class="one_quarter"><a class="btn" href="#">ICOTEL Calendar</a></footer>
    <!-- ################################################################################################ -->
  </article>
</div>
<!-- ################################################################################################ -->
  ...
  <footer id="footer" class="hoc clear">
    ...
    <div class="one_third first">
      ...
      <ul class="nospace btmspace-30 linklist contact">
        ...
        <li><i class="fa fa-phone"></i> +237698158886</li>
        <li><i class="fa fa-envelope-o"></i> icotel@ubuea.cm</li>
      </ul>
      <ul class="faico clear">
        <li><a class="faicon-facebook" href="https://web.facebook.com/icotelub"><i class="fa fa-facebook"></i></a></li>
        <li><a class="faicon-twitter" href="#"><i class="fa fa-twitter"></i></a></li>
    ...
    <div class="one_third">
      ...
      <!-- <ul class="nospace linklist">
        <li>
          <article>
            <h2 class="nospace font-x1"><a href="#">Lacus dui bibendum ut</a></h2>
            <time class="font-xs block btmspace-10" datetime="2045-04-06">Friday, 6<sup>th</sup> April 2045</time>
            <p class="nospace">Turpis cum sociis natoque penatibus et magnis dis parturient montes&hellip;</p>
          </article>
        </li>
        <li>
          <article>
            <h2 class="nospace font-x1"><a href="#">Felis at malesuada facilisis</a></h2>
            <time class="font-xs block btmspace-10" datetime="2045-04-05">Thursday, 5<sup>th</sup> April 2045</time>
            <p class="nospace">Nascetur ridiculus mus integer feugiat pulvinar leo ut sodales quam&hellip;</p>
          </article>+-+
        </li>
      </ul> -->
    </div>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear">
    <!-- ################################################################################################ -->
    <p class="fl_left">Click here to go to the <a href="http://www.ubuea.cm/" target='_blank'>UB Website</a></p>
